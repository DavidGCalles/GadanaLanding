...
<template>
  <header>
    ...
    <div class="wrapper">
      <HelloWorld msg="Gadana Solutions" />
      ...
      <a href="https://web.telegram.org" target="_blank" rel="noopener"><img alt = "telegram-logo" class="whas-logo" src="@/assets/logo-telegram.png" width="32" height="32"></a>
